...
int main(void)
{
	...
	root = binary_tree_node(NULL, 888);
	...
	root->left = binary_tree_node(root, 555);
	...
	root = binary_tree_node(NULL, 666);
	root->left = binary_tree_node(root, 777);
	root->right = binary_tree_node(root, 555);
	...
	root->right->left = binary_tree_node(root, 666);
	...
	/* root->left->left->left = binary_tree_node(root->left->left, 8); */
	root->left->right->right = binary_tree_node(root->left->right, 8);
	root->right->right = binary_tree_node(root->right, 78);
	binary_tree_print(root);
	complete = binary_tree_is_complete(root);
	printf("Is %d complete: %d\n", root->n, complete);
